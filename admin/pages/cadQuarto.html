                ...
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <?php
                        ...
                        if(isset($_REQUEST["acao"]) == "editar") {
                                $id      = $_REQUEST["id"];
                                $dao     = new Cliente_QuartosDAO();
                                $dados   = $dao->buscarDados($id);
                                $destino = "editarcliente_quartos.php";
                                $hidden  = true;
                        } else {
                                $dados = new Cliente_Quartos();
                                $destino = "cadastrarcliente_quartos.php";
                                $hidden = false;
                        }
                    ?>
                    <form role="form" action="<?php echo $destino; ?>" method="post">
                      <div class="form-group">                      
                        ...
                        <label>Descrição</label>
                        <input id="cliente_id" class="form-control" placeholder="Cliente" required="required">
